"""Account sessions and durable single-use QQ operation approvals."""
...
revision = "0026_admin_accounts_otp"
down_revision = "0025_ops_management"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    raise RuntimeError("Account and approval audit records must be preserved")
